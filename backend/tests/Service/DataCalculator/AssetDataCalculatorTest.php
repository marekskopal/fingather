			...
			'multi-broker interleaved buys and sells' => [
				'transactions' => [
					...
					TransactionFixture::getTransaction(
						...
						priceTickerCurrency: new Decimal(200),
					...
					TransactionFixture::getTransaction(
						...
						priceTickerCurrency: new Decimal(150),
					...
					TransactionFixture::getTransaction(
						brokerId: 2,
						actionType: TransactionActionTypeEnum::Sell,
						actionCreated: new DateTimeImmutable('2024-04-01'),
						units: new Decimal(-5),
						price: new Decimal(250),
						priceTickerCurrency: new Decimal(250),
						priceDefaultCurrency: new Decimal(250),
						taxTickerCurrency: new Decimal(0),
						taxDefaultCurrency: new Decimal(0),
						feeTickerCurrency: new Decimal(0),
						feeDefaultCurrency: new Decimal(0),
				...
				'gainDefaultCurrency' => 0.0,
				'gainPercentage' => 0.0,
				// B1: 10*(150-100)=500, B2: 5*(250-200)=250, total=750
				'realizedGain' => 750.0,
				'realizedGainDefaultCurrency' => 750.0,
				'dividendYield' => 0.0,
				'dividendYieldDefaultCurrency' => 0.0,
			],
			'Real data: Tesla' => [
