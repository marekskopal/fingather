...
#[CoversClass(XtbLegacyMapper::class)]
#[UsesClass(MappingDto::class)]
final class XtbLegacyMapperTest extends AbstractMapperTestCase
{
	protected static string $currentTestFile = 'xtb_old_export.xlsx';

	public function testGetImportType(): void
	{
		$mapper = new XtbLegacyMapper();
	...
	private function getXtbRecords(): array
	{
		...
		$fileContent = file_get_contents(__DIR__ . '/../../../Fixtures/Import/File/xtb_old_export.xlsx');
		if ($fileContent === false) {
