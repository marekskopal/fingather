...
class InitMigration extends Migration
{
	...
	public function up(): void
	{
		...
		$this->table('group_datas')
			...
			->addColumn('gain_percentage_per_annum', 'float', ['nullable' => false, 'default' => null])
			...
			->addColumn('dividend_gain_percentage_per_annum', 'float', ['nullable' => false, 'default' => null])
			...
			->addColumn('fx_impact_percentage_per_annum', 'float', ['nullable' => false, 'default' => null])
			...
			->addColumn('return_percentage_per_annum', 'float', ['nullable' => false, 'default' => null])
