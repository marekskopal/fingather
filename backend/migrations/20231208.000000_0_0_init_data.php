...
class InitDataMigration extends Migration
{
	...
	public function up(): void
	{
		$this->database()->insert('currencies')->values([
			['id' => 1, 'code' => 'USD', 'name' => 'US Dollar', 'symbol' => '$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 2, 'code' => 'EUR', 'name' => 'Euro', 'symbol' => '€', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 3, 'code' => 'GBP', 'name' => 'British Pound', 'symbol' => '£', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 4, 'code' => 'GBX', 'name' => 'British Pound (penny)', 'symbol' => 'p', 'multiply_currency' => 3, 'multiplier' => 100, 'is_selectable' => false],
			['id' => 5, 'code' => 'CZK', 'name' => 'Czech Crown', 'symbol' => 'Kč', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 6, 'code' => 'CAD', 'name' => 'Canadian Dollar', 'symbol' => 'CA$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 7, 'code' => 'DKK', 'name' => 'Danish krone', 'symbol' => 'kr.', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 8, 'code' => 'NOK', 'name' => 'Norwegian krone', 'symbol' => 'kr', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 9, 'code' => 'SEK', 'name' => 'Swedish krona', 'symbol' => 'kr', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 10, 'code' => 'CHF', 'name' => 'Swiss franc', 'symbol' => 'fr.', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 11, 'code' => 'RUB', 'name' => 'Russian ruble', 'symbol' => '₽', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 12, 'code' => 'TRY', 'name' => 'Turkish lira', 'symbol' => '₺', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 13, 'code' => 'HUF', 'name' => 'Hungarian forint', 'symbol' => 'Ft', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 14, 'code' => 'ARS', 'name' => 'Argentine peso', 'symbol' => 'Arg$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 15, 'code' => 'BRL', 'name' => 'Brazilian real', 'symbol' => 'R$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 16, 'code' => 'CLP', 'name' => 'Chilean peso', 'symbol' => '$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 17, 'code' => 'MXN', 'name' => 'Mexican peso', 'symbol' => '$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 18, 'code' => 'PEN', 'name' => 'Peruvian sol', 'symbol' => 'S/', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 19, 'code' => 'AUD', 'name' => 'Australian dollar', 'symbol' => '$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 20, 'code' => 'CNY', 'name' => 'Renminbi', 'symbol' => '¥', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 21, 'code' => 'HKD', 'name' => 'Hong Kong dollar', 'symbol' => 'HK$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 22, 'code' => 'INR', 'name' => 'Indian rupee', 'symbol' => '₹', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 23, 'code' => 'IDR', 'name' => 'Indonesian rupee', 'symbol' => 'Rp', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 24, 'code' => 'ILS', 'name' => 'Israeli new shekel', 'symbol' => '₪', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 25, 'code' => 'ILA', 'name' => 'Israeli new shekel (agora)', 'symbol' => 'a', 'multiply_currency' => 24, 'multiplier' => 100, 'is_selectable' => false],
			['id' => 26, 'code' => 'JPY', 'name' => 'Japanese yen', 'symbol' => '¥', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 27, 'code' => 'MYR', 'name' => 'Malaysian ringgit', 'symbol' => 'RM', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 28, 'code' => 'QAR', 'name' => 'Qatari riyal', 'symbol' => 'QR', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 29, 'code' => 'SAR', 'name' => 'Saudi riyal', 'symbol' => 'SR', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 30, 'code' => 'SGD', 'name' => 'Singapore dollar', 'symbol' => 'S$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 31, 'code' => 'KRW', 'name' => 'South Korean won', 'symbol' => '₩', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 32, 'code' => 'TWD', 'name' => 'New Taiwan dollar', 'symbol' => 'NT$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 33, 'code' => 'THB', 'name' => 'Thai baht', 'symbol' => '฿', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 34, 'code' => 'AED', 'name' => 'United Arab Emirates dirham', 'multiply_currency' => null, 'symbol' => 'Dh', 'multiplier' => 1, 'is_selectable' => true],
			['id' => 35, 'code' => 'EGP', 'name' => 'Egyptian pound', 'symbol' => 'E£', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 36, 'code' => 'EGP', 'name' => 'South African rand', 'symbol' => 'R', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
			['id' => 37, 'code' => 'EGP', 'name' => 'South African rand (cent)', 'symbol' => 'c', 'multiply_currency' => 36, 'multiplier' => 100, 'is_selectable' => false],
			['id' => 38, 'code' => 'NZD', 'name' => 'New Zealand dollar', 'symbol' => '$', 'multiply_currency' => null, 'multiplier' => 1, 'is_selectable' => true],
		])->run();
		...
		$this->database()->insert('markets')->values([
			...
			['id' => 76, 'type' => 'Stock', 'name' => 'Taiwan Stock Exchange', 'acronym' => 'TWSE', 'mic' => 'XTAI', 'country' => 'TW', 'city' => 'Taipei', 'timezone' => 'Asia/Taipei', 'currency_id' => 32],
			['id' => 77, 'type' => 'Stock', 'name' => 'Stock Exchange of Thailand', 'acronym' => 'SET', 'mic' => 'XBKK', 'country' => 'TH', 'city' => 'Bangkok', 'timezone' => 'Asia/Bangkok', 'currency_id' => 33],
			['id' => 78, 'type' => 'Stock', 'name' => 'Abu Dhabi Securities Exchange', 'acronym' => 'ADX', 'mic' => 'XADS', 'country' => 'AE', 'city' => 'Abu Dhabi', 'timezone' => 'Asia/Dubai', 'currency_id' => 34],
			['id' => 79, 'type' => 'Stock', 'name' => 'Egyptian Exchange', 'acronym' => 'EGX', 'mic' => 'XCAI', 'country' => 'EG', 'city' => 'Cairo', 'timezone' => 'Africa/Cairo', 'currency_id' => 35],
			['id' => 80, 'type' => 'Stock', 'name' => 'Johannesburg Stock Exchange', 'acronym' => 'JSE', 'mic' => 'XJSE', 'country' => 'ZA', 'city' => 'Johannesburg', 'timezone' => 'Africa/Johannesburg', 'currency_id' => 37],
			['id' => 81, 'type' => 'Stock', 'name' => 'New Zealand Exchange Ltd', 'acronym' => 'NZX', 'mic' => 'XNZE', 'country' => 'NZ', 'city' => 'Wellington', 'timezone' => 'Pacific/Auckland', 'currency_id' => 38],

			['id' => 82, 'type' => 'Crypto', 'name' => 'Binance', 'acronym' => '', 'mic' => '', 'country' => '', 'city' => '', 'web' => '', 'currency_id' => 1],
