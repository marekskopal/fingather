...
final class ApplicationFactory
{
	...
	private static function initializeContainer(DbContext $dbContext): ContainerInterface
	{
		...
		$container->add(TickerIndustryRepository::class, fn () => $orm->getRepository(TickerIndustry::class));
		$container->add(TickerRepository::class, fn () => $orm->getRepository(Ticker::class));
		$container->add(TickerSectorRepository::class, fn () => $orm->getRepository(TickerSector::class));
